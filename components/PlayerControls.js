...
const PlayerControls=({songs}) => {
  const{ currentSong, isPlaying, isPaused,volume, onVolumeChange,timestamp, progress, playNext,playPrevious,play,pause,onProgressChange} = useContext(SpotifyContext)
